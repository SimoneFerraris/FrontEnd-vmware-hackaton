        ...
        <div className="overlap">
          <div className="overlap-group">
            <div className="div">
              ...
              <div className="text-wrapper-1">Getting bored?</div>
            ...
            <div className="overlap-3">
              ...
              <img
                ...
                alt="Discover img"
                src="https://c.animaapp.com/dHkemGNM/img/discoverimg.svg"
              />
            </div>
            <div className="overlap-4">
              ...
              <img
                ...
                alt="Activities img"
                src="https://c.animaapp.com/dHkemGNM/img/activitiesimg.svg"
              />
            </div>
          </div>
            ...
            <div className="overlap-6">
              <div className="help">
                <div className="overlap-group-2">
                  <img className="vector" alt="Vector" src="https://c.animaapp.com/dHkemGNM/img/vector.svg" />
                  <img className="img" alt="Vector" src="https://c.animaapp.com/dHkemGNM/img/vector-1.svg" />
                  <div className="rectangle-2" />
                </div>
              </div>
              <Lottie className="carbattery" animationData={carBattery} loop={true} />;            
              <div className="text-wrapper-6">00:13:00 h left</div>
              <div className="text-wrapper-7">Power: 6.0 kWh</div>
              <div className="text-wrapper-8">0.0121 kWh</div>
            </div>
            <div className="text-wrapper-9">Charging...</div>
          </div>
        </div>
      </div>
    </div>
