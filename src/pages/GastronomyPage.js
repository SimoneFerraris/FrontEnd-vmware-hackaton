//https://tourism.opendatahub.com/swagger/index.html#/ODHActivityPoi/get_v1_ODHActivityPoi
...
function POIList({ pois }) {
  ...
  return (
    <div>
    <div className="shops-text2">Shops</div>
    <div >
    ...
    async function getPlaces() {
        ...
        let response = await fetch(
            'https://tourism.opendatahub.com/v1/ODHActivityPoi?type=32&latitude=46.501313&longitude=11.339781&radius=3000&removenullvalues=false'
        );
